        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20 animate-fade-in-up delay-1400">
            ...
            >
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-[#006da6] to-[#180c2e] rounded-full blur opacity-30 group-hover:opacity-60 transition-opacity duration-700"></div>
            </Button>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#006da6]/10 to-[#180c2e]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-full"></div>
            </Button>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#006da6]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
            </Button>
          </div>
