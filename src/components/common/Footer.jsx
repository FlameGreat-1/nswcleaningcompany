      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <div className="space-y-8 animate-fade-in-up">
            <div className="relative group">
              ...
              <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu">
                ...
                <div className="relative z-10">
                  <h3 className="text-5xl font-black text-transparent bg-gradient-to-r from-[#006da6] via-[#0080c7] to-[#005a8a] bg-clip-text mb-4 group-hover:scale-110 transition-transform duration-500">
                    {COMPANY_INFO.name}
                  </h3>
                  <p className="text-[#CCCCCC] text-lg leading-relaxed font-medium group-hover:text-white transition-colors duration-500">
            ...
            <div className="relative group">
              ...
              <div className="relative flex items-center gap-3 bg-gradient-to-r from-[#006da6]/10 via-white/5 to-[#005a8a]/10 backdrop-blur-xl border border-[#006da6]/30 p-4 rounded-2xl hover:border-[#006da6]/50 transition-all duration-700 hover:-translate-y-1 hover:scale-105 transform-gpu overflow-hidden">
                ...
                <span className="relative text-lg font-black text-[#006da6] group-hover:text-white transition-colors duration-500">NDIS Approved Provider</span>
          ...
          <div className="animate-fade-in-up delay-200">
            <h4 className="text-lg font-black text-[#006da6] mb-8 relative group">
            ...
            <ul className="space-y-4">
              {quickLinks.map((link, index) => (
                <li key={link.name} className="group/link">
                  <Link 
                    to={link.path}
                    className="relative inline-flex items-center text-[#CCCCCC] hover:text-[#006da6] transition-all duration-500 text-lg font-medium group-hover/link:translate-x-2 group-hover/link:scale-105 transform-gpu"
          ...
          <div className="animate-fade-in-up delay-400">
            <h4 className="text-lg font-black text-[#006da6] mb-8 relative group">
              <span className="relative z-10 group-hover:text-white transition-colors duration-500">Our Services</span>
              <div className="absolute -bottom-2 left-0 w-0 h-1 bg-gradient-to-r from-[#006da6] to-[#005a8a] group-hover:w-full transition-all duration-700 rounded-full"></div>
            </h4>
            <ul className="space-y-4 mb-8">
              {serviceLinks.map((service, index) => (
                <li key={service.name} className="group/service">
                  <Link 
                    to={service.path}
                    className="relative inline-flex items-center text-[#CCCCCC] hover:text-[#006da6] transition-all duration-500 text-lg font-medium group-hover/service:translate-x-2 group-hover/service:scale-105 transform-gpu"
                    style={{ animationDelay: `${index * 100}ms` }}
                  >
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 hover:bg-white/10 transition-all duration-700 hover:-translate-y-1 hover:scale-105 transform-gpu overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-[#006da6]/5 via-transparent to-[#005a8a]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-2xl"></div>
                <div className="relative z-10">
                                      <h5 className="text-lg font-black mb-4 text-[#006da6] group-hover:text-white transition-colors duration-500">Service Areas</h5>
                  <div className="grid grid-cols-2 gap-2 text-base text-[#CCCCCC] mb-3">
                  ...
                  <span className="text-base text-[#006da6] font-black group-hover:text-white transition-colors duration-500 inline-flex items-center gap-1">
            ...
            <div className="space-y-6">
              <div className="relative group/contact">
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 hover:bg-white/10 transition-all duration-700 hover:-translate-y-1 hover:scale-105 transform-gpu">
                  ...
                  <div className="relative z-10">
                    <p className="text-lg font-black mb-2 text-[#006da6] group-hover/contact:text-white transition-colors duration-500">Phone</p>
                    <a 
              ...
              <div className="relative group/email">
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 hover:bg-white/10 transition-all duration-700 hover:-translate-y-1 hover:scale-105 transform-gpu">
                  ...
                  <div className="relative z-10">
                    <p className="text-lg font-black mb-2 text-[#006da6] group-hover/email:text-white transition-colors duration-500">Email</p>
                    <a 
                      href={`mailto:${COMPANY_INFO.email.support}`}
                      className="text-[#CCCCCC] hover:text-[#006da6] transition-colors duration-500 text-lg break-all font-medium group-hover/email:scale-105 inline-block transform-gpu"
                    >
              ...
              <div className="relative group/hours">
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 hover:bg-white/10 transition-all duration-700 hover:-translate-y-1 hover:scale-105 transform-gpu">
                  ...
                  <div className="relative z-10">
                    <p className="text-lg font-black mb-3 text-[#006da6] group-hover/hours:text-white transition-colors duration-500">Business Hours</p>
                    <div className="text-base text-[#CCCCCC] space-y-2 font-medium">
              ...
              <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 animate-fade-in-up delay-800">
                  ...
                  <div className="text-center sm:text-left">
                    <p className="text-[#006da6] font-black text-2xl mb-2 group-hover:text-white transition-colors duration-500">Follow Us</p>
                    <p className="text-[#CCCCCC] text-lg font-medium">Stay updated with our latest work</p>
                  </div>
                </div>
                  ...
                  <form onSubmit={handleNewsletterSubmit} className="relative flex flex-col sm:flex-row gap-4 items-center">
                    <div className="relative">
                      <input
                        ...
                        required
                        className="w-full sm:w-64 px-4 py-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl text-white placeholder-[#CCCCCC] focus:outline-none focus:border-[#006da6] focus:bg-white/20 transition-all duration-500 font-medium text-lg"
                      />
                    ...
                    <Button
                      ...
                      variant="primary"
                      size="md"
                      className="whitespace-nowrap bg-gradient-to-r from-[#006da6] via-[#0080c7] to-[#005a8a] hover:from-[#180c2e] hover:to-[#2d1b4e] transform hover:scale-105 hover:-translate-y-1 transition-all duration-500 text-lg"
                    >
                      Subscribe
                    </Button>
                  </form>
        ...
        <div className="relative">
          ...
          <div className="relative border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-4 text-lg text-[#CCCCCC] font-medium">
            ...
            <div className="flex items-center gap-2 text-lg text-[#CCCCCC] font-medium">
